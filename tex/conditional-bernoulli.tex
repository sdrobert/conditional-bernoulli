...
% Fortunately, \citet{serflingElementaryResultsPoisson1978} is just one of many
% results on approximating the sum of dependent Bernoulli trials. Approximating
% this distribution via the Poisson distribution lead to the famous Stein-Chen
% Method \cite{chenWeightedFinitePopulation1994}. Unfortunately, Poisson
% approximations to
...
%     dependent on the sequence of $B_{<t}$, not just the number of highs in the
%     sequence.
% \end{enumerate}
% %
